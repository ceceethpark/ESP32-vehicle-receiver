 ...
 */
#ifndef LCD_IO_GPIO8_H_
#define LCD_IO_GPIO8_H_
...
#define LCD_RS            C, 7
#define LCD_WR            B, 13
//#define LCD_RD          C, 6  /* If not used leave it that way */
#define LCD_RST           C, 9  /* If not used leave it that way */
...
#define LCD_BL            C, 8  /* If not used leave it that way */
#define LCD_BLON          1
